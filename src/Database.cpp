...
std::vector<sqlid_t> Database::dbSelectIds(shared_connection con, const std::string table, const std::string condition,
    ...
    std::string query = "SELECT " + std::string(HIBERLITE_PRIMARY_KEY_COLUMN) + " FROM " + table + where + order + ";";
