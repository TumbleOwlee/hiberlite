...
// #define HIBERLITE_COLLECTION(Field) hiberlite::collection_nvp<typeof(Field),typeof(Field.begin())>(#Field, Field,
// Field.begin(), Field.end()) #define HIBERLITE_ARRAY(Field,N)
